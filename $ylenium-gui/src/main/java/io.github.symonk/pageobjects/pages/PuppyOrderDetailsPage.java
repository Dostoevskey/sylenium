...
public class PuppyOrderDetailsPage {
  ...
  private final SelenideElement PLACE_ORDER_BUTTON = $x("//*[@id='new_order']/div[6]/input");
  private final SelenideElement ORDER_NAME_TEXTBOX = $(By.id("order_name"));
  private final SelenideElement ORDER_ADDRESS_TEXTBOX = $(By.id("order_address"));
  private final SelenideElement ORDER_EMAIL_TEXTBOX = $(By.id("order_email"));
  private final SelenideElement ORDER_PAYMENT_TYPE = $(By.id("order_pay_type"));
