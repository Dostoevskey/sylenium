...
public class SyleniumDriverListener implements WebDriverEventListener {

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(SyleniumDriverListener.class);
